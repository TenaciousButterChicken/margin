  ...
  return (
    <header className="topnav" style={{ padding: "0 56px" }}>
      ...
      <div style={{ marginLeft: 40 }}>
        <GooeyNav
          items={[
            { label: "Sessions",    href: "/sessions",    active: current === "sessions" },
            { label: "Simulations", href: "/simulations", active: current === "simulations" },
            { label: "About",       href: "/about",       active: current === "about" },
          ]}
        />
      </div>
