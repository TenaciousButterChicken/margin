...
For linear regression, you can. There's a closed-form formula called the normal equation. But for any model with hidden layers (neural networks), no closed-form exists. Gradient descent is the only option.
  </Q>
</FAQ>
